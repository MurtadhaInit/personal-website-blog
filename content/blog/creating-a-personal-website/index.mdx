...
description: I go through my experience using Astro to create a statically-generated personal website and blog
draft: true
category: Web
tags:
  - Frontend
...
## Great documentation is a winning formula
...
var fun = function lang(l) {
  dateformat.i18n = require("./lang/" + l); // [!code highlight]
  return true;
};
```
